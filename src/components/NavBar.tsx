...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed inset-0 z-50 pointer-events-none">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between pointer-events-auto">
          ...
          <a href="/" className="inline-flex">
            <img
              src="https://see.fontimg.com/api/rf5/6M9A/YjM1ZTY3ZGVkZTUxNGJhMTk3MzQ5NDU5YzQwNjE5MDEudHRm/QUg/janda-sparkle-and-shine.png?r=fs&h=213&w=1500&fg=FFFFFF&bg=0E0E0E&tb=1&s=142"
              alt="Stars fonts"
      ...
      <div
        className={`md:hidden fixed left-0 right-0 top-16 z-50 pointer-events-auto transition-all duration-300 ease-in-out ${isMenuOpen ? 'opacity-100 translate-y-0 backdrop-blur-md' : 'opacity-0 -translate-y-2 pointer-events-none'
          }`}
      >

  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-50 pointer-events-none">
      <div className="max-w-7xl mx-auto px-4">
        <div className="pointer-events-auto bg-black/20 backdrop-blur-md border-t border-black-500/20 rounded-t-xl px-4 py-3 flex flex-col md:flex-row items-center justify-between text-white">
          <div className="text-sm">Adam Hamou 2025</div>
          <div className="flex items-center gap-2 text-sm">
            <span>Straw Hat @ heart</span>
